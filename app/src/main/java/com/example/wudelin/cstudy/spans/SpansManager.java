package com.example.wudelin.cstudy.spans;
...
//                    Selection.removeSelection(buffer);
    ...
    public void setEtXY( RectF rf) {
        //设置et w,h的值
        android.support.v7.widget.CardView.LayoutParams lp = (android.support.v7.widget.CardView.LayoutParams) mEt.getLayoutParams();
